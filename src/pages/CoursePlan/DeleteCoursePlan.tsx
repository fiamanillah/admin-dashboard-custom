...
import { useDeleteCoursePlanMutation } from '@/features/coursePlan/coursePlanApi';

interface DeleteCoursePlanProps {
    id: string;
    onSuccess?: (message?: string) => void;
    trigger?: React.ReactNode;
}

export default function DeleteCoursePlan({ id, onSuccess, trigger }: DeleteCoursePlanProps) {
    const [open, setOpen] = useState(false);
    const [deleteCourse, { isLoading: isDeleting }] = useDeleteCoursePlanMutation();
